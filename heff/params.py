...
def thf_v2(isotopologue, *, a_par_th_sign="negative"):
    ...
    if isotopologue == "232":
        ...
        schmidt_note = (
            ...
            "because no source giving either number for the actinides was "
            "read: Schmidt values for deformed actinides are said to be "
            "wrong by a factor ~2, and the commonly quoted quenched range "
            "is g_s^eff ~ 0.6-0.7 g_s^free (which would move A_par to ~+24 "
            "to +28 GHz). They are the SIZE of the effect, not a corrected "
            "value; the one MEASURED quenching read (the Ca isotopes, Fan & "
            "Zamick arXiv:2201.13247 S2.2) is a factor ~0.73. The (1/2+) "
            "spin assignment is itself tentative (the 5/2+ "
